...
<body>
	...
	<ul class="nav nav-pills">
		<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/member/myPage">예매내역</a></li>
	...
	<div class="col-sm-6, container" style="text-align: center;">
		<h1>카드 가운데 정렬 해야함</h1>
		<form name="updateForm" id="inForm" method="post" action="${pageContext.request.contextPath}/member/update">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<label class="col-form-label col-form-label-lg mt-4"
							...
							<input
							class="form-control form-control-lg" type="text"
							placeholder="${member.birth}" id="birth"
					...
					<br>
					<div>
						<button type="submit" class="btn btn-primary">회원정보 수정 완료</button>
					</div>
					<br>
